    ...
    <sidebar-layout>
                ...
                <div class="row">
                    <div class="col-md-4 mb-4">
                        ...
                        <input
                            ...
                            type="text"
                            class="form-control"
                            placeholder="Presione la tecla Enter"
        ...
        <div class="card mb-2">
            <collapse titulo="Servicio de Rentas Internas (SRI)">
                ...
                <div v-show="reporte.tiene_ruc" class="row pt-4">
                    <div class="col-md-4 mb-4">
                    ...
                    <div class="col-12 mb-3">
                        <div class="form-check">
                            <input
                                ...
                                id="puntuaciones"
                            />
                            <label class="form-check-label" for="puntuaciones">
                                Tiene puntuaciones
                            </label>
                        </div>
                    </div>
        ...
        <div class="card mb-2">
            <collapse titulo="Operaciones de crédito comerciales">
                <div class="row">
                    ...
                    <div
                        v-show="reporte.tiene_operaciones_credito_comerciales"
                        class="col-12"
                    >
                        <listado
                            :configuracion-columnas="
        ...
        <div class="card mb-2">
            <collapse titulo="Historial crediticio">
                <div class="row">
                    ...
                    <div v-show="reporte.tiene_historial" class="col-12 mb-3">
                        <listado
                            :configuracion-columnas="
                    ...
                    <div class="col-md-4">
                        <div class="form-check">
                            <input
                                ...
                                id="cuota_mensual"
                            />
                            <label class="form-check-label" for="cuota_mensual">
                                Tiene cuota mensual
                            </label>
                        </div>
                    </div>
        ...
        <div class="card mb-2">
            ...
            >
                <div class="row">
                    ...
                    <div v-show="reporte.tiene_consultas" class="col-12 mb-3">
                        <listado
                            :configuracion-columnas="
        ...
        <div class="card mb-2">
            <collapse titulo="Análisis de saldos por vencer Sistema Financiero">
                <div class="row">
                    <div class="col-12 mb-3">
                        <div class="form-check">
                            <input
        ...
        <button
            class="btn btn-success text-white generar-reporte"
            @click="generarReporte()"
        >
            Previsualizar reporte<i class="bi-chevron-right ms-2"></i>
        </button>
