...
<div id="mejoramientos" class="row row-cols-md-3 row-cols-1 pt-4 mb-4 d-none mx-4">
    ...
    <div class="col mb-2">
        <div class="rounded-card h-100 gradiente-morado text-white">
            {{-- Imagen --}}
            <div class="card-body text-white">
                ...
                <div class="w-100 text-white">
                    ...
                    <div class="mb-2 gradiente-blanco rounded-card p-2">{!! $plan->descripcion !!}</div>
...
<div id="reportes" class="row row-cols-md-3 row-cols-1 pt-4 mb-4 d-none mx-4">
    ...
    <div class="col mb-2">
        <div class="card h-100 gradiente-azul-morado">
            ...
            <div class="card-body">
                <div class="text-center">
                    <img width="100px" class="mb-4" src="{{ $plan->images?->url ?? url('img/logo.webp') }}" alt="">
                </div>
