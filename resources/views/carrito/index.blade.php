...
@section('content')
    <div class="text-center pt-4 px-4 mb-4">
        <h3>
            Adquirir servicio
        </h3>
    </div>
    <div class="container mx-auto row py-4 bg-white gradiente-blanco border rounded-card"
        style="margin: 0 16px calc(100vh - 550px) 16px">
        {{-- Columna 1 --}}
        <div class="col-md-4">
            <div class="mb-4 border-end">
                <div class="mx-2">
                    <div class="row p-2">
                        {{-- Imagen 
                        ...
                        {{-- Detalles --}}
                        <div class="col-12">
                            <span class="h3 fw-bold">{{ $servicio->nombre }}</span><br>
            ...
            <div class="p-4">
                ...
                <form method="POST" action="{{ route('public.servicios.store') }}">
                    ...
                    <div class="row">
                        ...
                        <small class="d-block py-2 text-center">@Copyright {{ now()->year }} <b>Buró de Crédito
                                Ecuador</b></small>
                    </div>
                    ...
                    <div class="row d-none">
                        ...
                        {{-- <div class="col-lg-6 col-md-12 mb-4">
                            ...
                            <input id="correo" type="email" class="form-control @error('correo') is-invalid @enderror"
                                name="correo" value="{{ old('email') }}" required autocomplete="correo"
